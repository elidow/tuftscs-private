...
extern void emit_output_adv_test(Seq_T instructions);

extern void emit_verbose_halt_test(Seq_T instructions);

extern void emit_load_value_test(Seq_T instructions);
    ...
    static struct test_info
{
        ...
        { "load-value",   NULL, "", emit_load_value_test },
        ...
        {"conditional-move", NULL, "", emit_conditional_move_test },
        { "input",        NULL, "", emit_input_test },
        { "adv-output",   NULL, "", emit_output_adv_test },
        {"map-segment",   NULL, "", emit_map_segment_test },
        {"segmented-store", NULL, "", emit_segmented_store_test },
        {"segmented-load", NULL, "", emit_segmented_load_test},
        {"unmap-segment", NULL, "", emit_unmap_segment_test },       
